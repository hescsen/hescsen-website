...
define( "RECIPIENT_NAME", "Sylvain Nicolet" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "info@hescsen.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Message d'un visiteur" ); //UPDATE THIS TO YOUR SUBJECT
